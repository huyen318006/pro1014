...
<head>
    ...
    <title>Thêm Dịch vụ đi kèm</title>
        ...
        <div class="card shadow-lg border-0">
            <div class="card-header bg-success text-white">
                <h3 class="mb-0 text-center">
                    <i class="bi bi-plus-circle-fill"></i> Thêm Dịch vụ đi kèm
                </h3>
            </div>
                ...
                <form action="index.php?act=servicesStore" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <select name="departure_id" class="form-select form-select-lg" required>
                            ...
                            <?php foreach (($departures ?? []) as $dep): 
                                ...
                                $display = ($dep['tour_name'] ?? 'Tour ID: ' . $dep['tour_id'])
                                    . ' - ' . ($dep['departure_date_formatted'] ?? '')
                                    . ' (' . ($dep['meeting_point'] ?? 'Không rõ') . ')';
                            ?>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="service_name" class="form-control form-control-lg" 
                               ...
                               placeholder="Ví dụ: Khách sạn, Xe du lịch, Nhà hàng..." required>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="partner_name" class="form-control form-control-lg" 
                               ...
                               placeholder="Ví dụ: Ha Long Pearl Hotel, Xe Phương Trang..." required>
                    </div>
                    ...
                    <div class="mb-4">
                        <label class="form-label fw-bold">
                            <i class="bi bi-chat-dots"></i> Ghi chú
                        </label>
                        <textarea name="note" class="form-control" rows="5" 
                                  placeholder="Ví dụ: Đặt 10 phòng đôi, Xe 45 chỗ, Check-in 14h..."><?= htmlspecialchars($old['note'] ?? '') ?></textarea>
                    </div>
                    ...
                    <div class="d-grid d-md-flex justify-content-end gap-3 mt-5">
                        ...
                        <button type="submit" class="btn btn-success btn-lg px-5">
                            <i class="bi bi-save"></i> Thêm dịch vụ
                        </button>
                    </div>
                </form>
            </div>

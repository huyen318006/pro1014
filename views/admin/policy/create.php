...
<head>
  ...
  <!-- CSS chung + CSS riêng cho chính sách -->
...
<body>
  ...
  <div class="sidebar">
    ...
    <h4>ADMIN</h4>
    <a href="<?= BASE_URL ?>?act=home"><i class="fas fa-tachometer-alt"></i> <span>Dashboard</span></a>
    <a href="<?= BASE_URL ?>?act=account"><i class="fas fa-users-cog"></i> <span>Quản lý tài khoản</span></a>
    <a href="<?= BASE_URL ?>?act=listTours"><i class="fas fa-map-marked-alt"></i> <span>Quản lý Tour</span></a>
    <a href="<?= BASE_URL ?>?act=listItinerary"><i class="fas fa-route"></i> <span>Quản lý Lịch Trình</span></a>
    <a href="<?= BASE_URL ?>?act=listAssignments"><i class="fas fa-user-check"></i> <span>Phân công HDV</span></a>
    <a href="<?= BASE_URL ?>?act=services"><i class="fas fa-concierge-bell"></i> <span>Quản lý Dịch Vụ</span></a>
    <a href="<?= BASE_URL ?>?act=policies" class="active"><i class="fas fa-scroll"></i> <span>Quản lý Chính Sách</span></a>
    <a href="<?= BASE_URL ?>?act=incidents"><i class="fas fa-exclamation-triangle"></i> <span>Báo cáo sự cố</span></a>
  ...
  <!-- HEADER -->
  <div class="header">
    <h5><i class="fas fa-scroll"></i> Thêm chính sách mới</h5>
    <div class="user-info">
    ...
    <div class="container-fluid mt-4">
      ...
      <div class="policy-card p-4 p-md-5">
        <h3 class="mb-4 text-primary">
          <i class="fas fa-plus-circle"></i> Thêm chính sách tour mới
        </h3>

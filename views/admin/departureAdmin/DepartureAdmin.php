    ...
    <table class="departure-table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                  <a href=""><i class="fas fa-edit" title="Sửa lịch khởi hành"></i></a>
                  <a href=""><i class="fas fa-trash" title="Xóa"></i></a>
...
a i.fas {
    ...
    transition: color 0.3s, transform 0.2s; /* hiệu ứng khi hover */
}

/* Hover đổi màu và nhẹ phóng to */
a i.fas:hover {
    color: #007bff;        /* đổi màu xanh khi hover */
    transform: scale(1.2); /* phóng to 20% */
}

/* Icon riêng biệt nếu muốn màu khác nhau */
a i.fa-edit {
    color: #28a745; /* màu xanh lá cho sửa */
}
